...
/* */
	/*
	 * GEMDOS reports a four-byte file size.  Keep the on-disk value as two
	 * explicit little-endian words; Desktop arithmetic uses carry-aware word
	 * helpers and never asks ia16-gcc for a four-byte scalar operation.
	 */
	GEM_U32_WORDS	f_size;			// 08

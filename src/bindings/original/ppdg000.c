...
/* Form Manager			*/
	...
	0, 0, 0, 			/* func 009		*/
/* Process Manager		*/
	2, 2, 2, 			/* func 060 proc_create */
	3, 1, 2, 			/* func 061 proc_run	*/
	1, 1, 0, 			/* func 062 proc_delete */
	1, 3, 0, 			/* func 063 proc_info	*/
	0, 1, 1, 			/* func 064 proc_malloc */
	1, 1, 0, 			/* func 065 proc_mfree	*/
	1, 1, 0, 			/* func 066 proc_switch */
	1, 1, 0, 			/* func 067 proc_shrink */
	0, 0, 0, 			/* func 008		*/
	0, 0, 0, 			/* func 009		*/
/* Graphics Manager	*/
	4, 3, 0, 			/* func 070		*/
...
GLOBAL GEM_BINDINGS_AESPB gb;
GLOBAL UWORD		control[C_SIZE];
GLOBAL WORD		global[G_SIZE];
GLOBAL UWORD		int_in[I_SIZE];
GLOBAL UWORD		int_out[O_SIZE];
GLOBAL GEM_BINDINGS_POINTER_SLOT addr_in[AI_SIZE];
GLOBAL GEM_BINDINGS_POINTER_SLOT addr_out[AO_SIZE];

GLOBAL GEM_BINDINGS_AESPB *ad_g;
